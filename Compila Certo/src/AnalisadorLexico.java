							...
							if(lexema.length() > 1){
								if(lexema.charAt(1) == 'x'){
									if(lexema.length() == 4){
										...
										simbolo = simbolos.inserirConstante(lexema, "tipo_byte");
									} else {
										System.err.println(linha + ":Lexema não esperado: " + lexema);
										System.exit(0);
									}
									...
									simbolo = simbolos.inserirConstante(lexema, "tipo_inteiro");
								}
